...
namespace BIMTools
{
    public partial class PlaceFamilySymbolsWindow : System.Windows.Forms.Form
    {
        ...
        private void SelectedFamily(object sender, EventArgs e)
        {
            ...
            var familySymbolsIds = FEC.Cast<Family>().Where(f => f.Name == familyName).First().GetFamilySymbolIds();
        ...
        private void Start(object sender, EventArgs e)
        {
            ...
            using (Transaction transaction = new Transaction(doc))
            {
                ...
                else if (symbolCategory.Id.IntegerValue == (int)BuiltInCategory.OST_Walls)
                {
                    var x1 = 0; var x2 = 10;
                    int y1, y2;
                    y1 = y2 = 0;
